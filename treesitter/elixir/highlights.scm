...
; capture docs
(unary_op operator: "@"
 (call (function_identifier) @elixir.docs.identifier
       (heredoc))
 (#set! "priority" 110)
 (#match? @elixir.docs.identifier "^(doc|moduledoc|typedoc)$")) @elixir.docs

; capture specs
(unary_op
 operator: "@"
 (call (function_identifier) @elixir.spec.identifier
       (binary_op (call (function_identifier))))
 (#set! "priority" 110)
 (#eq? @elixir.spec.identifier "spec")) @elixir.spec
